  ...
  return (
    <section className="JocastaNuu_Container Featured_Border">
      ...
      <div className="JocastaNuu_Text">
        <p>
          Jedi Master and primary caretaker of the extensive Archives, assisting fellow Jedi
          find the information they needed, while controlling access to several
          restricted vaults and artifacts.
        </p>
      </div>
    </section>
  );
